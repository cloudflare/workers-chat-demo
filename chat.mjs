...
// uploaded and exposed as synthetic modules. We uploaded `chat.html` as a module of type
// `application/octet-stream`, i.e. just a byte blob. So when we import it as `HTML` here, we get
